 ...
 * song has completely finished. For this, use Rick's class SongPlayer with
 * method playSong that takes an EndOfSongListener as its first argument.
 *
 * @author Java Zoom, Rick Mercer and Jorge Vergara
 */
package model.Music;
